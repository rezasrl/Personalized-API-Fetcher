...
abstract class Assets {
	...
	public static function get_styles() {
		...
		return apply_filters( 'personalized_api_fetcher_enqueue_styles', array() );
	}
	...
	public static function get_scripts() {
		...
		return apply_filters( 'personalized_api_fetcher_enqueue_scripts', array() );
	}
	...
	public static function load_scripts() {
		...
		if ( ! did_action( 'before_personalized_api_fetcher_init' ) ) {
			return;
		}
